...
<div class="container">
    <form:form name="/registration" action="/registration" modelAttribute="user" method="post">
        ...
        <div class="form-group col-lg-offset-4 col-lg-5" >
            ...
            <form:input path="name" type="text" class="form-control " id="InputName1" placeholder="Например, Алексей"></form:input>
        </div>
        </spring:bind>
        <div class="form-group col-lg-offset-4 col-lg-5">
            <label for="InputSurname1">Введите вашу фамилию</label>
            <form:input path="lastName" type="text" class="form-control" id="InputSurname1" placeholder="Например, Кривотулов"></form:input>
            <form:errors path="name"></form:errors>
        </div>
        <div class="form-group col-lg-offset-4 col-lg-5">
            <label for="InputAge1">Введите ваш возраст</label>
            <form:input path="age" type="text" class="form-control" id="InputAge1" placeholder="Например, 22"></form:input>
        </div>
        <div class="form-group  col-lg-offset-4 col-lg-5">
        ...
        <div class="form-group col-lg-offset-4 col-lg-5">
            ...
            <form:input path="numberOfDoc" type="text" class="form-control" id="InputDoc1" placeholder="Например, 222222222"></form:input>
        </div>
        <div class="form-group col-lg-offset-4 col-lg-5">
            <label for="InputEmail1">Введите ваш Email</label>
            <form:input path="email" type="email" class="form-control" id="InputEmail1" placeholder="Например, carService@gmail.com"></form:input>
        </div>
        <div class="form-group  col-lg-offset-4 col-lg-5">
            <label for="InputPassword1">Введите пароль</label>
            <form:input path="password" type="password" class="form-control" id="InputPassword1" placeholder="Пароль"></form:input>
