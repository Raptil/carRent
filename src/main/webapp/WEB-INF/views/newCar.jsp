    ...
    <form:form name="/newCar" action="/newCar" modelAttribute="car" method="post">
        <div class="row">
            <div class="form-group col-lg-6">
                ...
                <form:input path="bodyType" type="text" class="form-control " id="InputBodyType1"
                            placeholder="Например, седан"></form:input>
            </div>
            <div class="form-group col-lg-6">
            ...
            <div class="form-group  col-lg-6">
                ...
                <form:input path="colour" type="text" class="form-control" id="InputColour1"
                            placeholder="Например, черный"></form:input>
            </div>
            <div class="form-group   col-lg-6">
                <label for="InputFuel1">Введите затраты топлива л/100км</label>
                <form:input path="fuel100" type="text" class="form-control" id="InputFuel1"
                            placeholder="Например, 9"></form:input>
            </div>

            <div class="form-group  col-lg-6">
                <label for="InputModel1">Введите название модели</label>
                <form:input path="model" type="text" class="form-control" id="InputModel1"
                            placeholder="Например, Volkswagen"></form:input>
            </div>
            <div class="form-group  col-lg-6">
                <label for="InputNumberOfDoc1">Введите номер свидетельства о ригестрации</label>
                <form:input path="numberOfDoc" type="text" class="form-control" id="InputNumberOfDoc1"
                            placeholder="Например, 111111111"></form:input>
            </div>
            <div class="form-group  col-lg-6">
                <label for="InputPriceDay1">Введите стоимость аренды за день</label>
                <form:input path="priceDay" type="text" class="form-control" id="InputPriceDay1"
                            placeholder="Например, 1500"></form:input>
            </div>
            <div class="form-group   col-lg-6">
                <label for="InputStateNumber1">Введите гос. номер</label>
                <form:input path="stateNumber" type="text" class="form-control" id="InputStateNumber1"
                            placeholder="Например, а554ам136rus"></form:input>
            </div>
            <div class="form-group  col-lg-6">
                <label for="InputYearOld1">Введите год выпуска</label>
                <form:input path="yearsOld" type="text" class="form-control" id="InputYearOld1"
                            placeholder="Например, 2006"></form:input>
            </div>
            <div class="form-group col-lg-6">
                <label for="InputOtherDescription1">Введите подробное описание</label>
                <form:input path="otherDescription" type="text" class="form-control" id="InputOtherDescription1"
                            placeholder="Чтобы вы хотели дополнительно рассказать о транспорте?!"></form:input>
            </div>
